            ...
            >
                  ...
                  <>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {d.symptoms.slice(0, 3).map((s, idx) => (
                        <span
                          key={idx}
                          className="px-2.5 py-1 rounded-lg text-xs bg-gray-100"
                        >
                          {s}
                        </span>
                      ))}
              ...
              <Link
                ...
                className="
                  ...
                  text-sm font-medium text-gray-900 px-4 py-2 w-full overflow-hidden
                  transition hover:bg-gray-200 cursor-pointer rounded-lg
                  group-hover:text-blue-600 hover:font-bold
                "
              >
