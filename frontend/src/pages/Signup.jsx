      ...
      >
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2 rounded-lg font-medium cursor-pointer text-white bg-gradient-to-r from-blue-500 to-emerald-500 hover:opacity-90 transition disabled:opacity-60"
          >
        ...
        <button
          ...
          disabled={loading}
          className={`
            w-full py-2.5 rounded-lg border font-medium transition-all
            flex items-center justify-center gap-3
            disabled:opacity-60 disabled:cursor-not-allowed cursor-pointer hover:shadow-sm
            ${
              isDark
                ? "border-slate-600 hover:bg-slate-800 bg-[#131314]"
